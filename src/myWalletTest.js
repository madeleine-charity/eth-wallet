...
async function testWallet() {
    ...
    const wallet1 = new myWallet_1.default();
    ...
    const wallet2 = new myWallet_1.default(privateKey);
    assert_1.default.strictEqual(wallet2.wallet.address, '0x2d85DdC88EFa2B9c9cD7Cd9dAd6Acb9110Aa374C');
    // Test 3: Get balance
    const balance1 = await wallet1.getBalance();
    const balance2 = await wallet2.getBalance();
    assert_1.default.strictEqual(balance1, '0.0');
    ...
    assert_1.default.strictEqual(signature2, '0xa3ff9f523ea55928d0977698cbbd018b891beedabd8183aa93ad9202c9fbde760ead32acba63472a34d3d3198f149a1799932c7ba40b5f32f0c84ba9272e41a81b');
    console.log('Random Wallet Signature:', signature1);
    // Test 5: Send a transaction
    const wallet3 = new myWallet_1.default('0xee44bc68ca6a5ab9268f9c1f24511e46c2b04692eec82e51c8cf0bcbb2395b46');
    ...
    if (Number(balance2) > 0.003) {
        ...
        (0, assert_1.default)(typeof txHash1 == 'string'); // assert hash 
    }
    else {
